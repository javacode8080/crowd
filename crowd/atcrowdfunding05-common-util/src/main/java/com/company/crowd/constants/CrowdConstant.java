package com.company.crowd.constants;
...
public class CrowdConstant {
	...
	public static final String MESSAGE_PIC_UPLOAD_FAILED_FORMAT_ERROR = "图片格式错误，请重新上传！";
	...
	public static final String MESSAGE_TEMPLE_PROJECT_MISSING = "临时存储的Project对象丢失！【考虑session共享，前一个页面存储session的问题】";

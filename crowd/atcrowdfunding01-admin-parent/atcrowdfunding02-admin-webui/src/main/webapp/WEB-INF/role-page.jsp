...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveRoleBtn").click(function(){
			...
			var roleName = $.trim($("#addModal [name=roleName]").val());/*trim用来去除前后空格*/
		...
		$("#rolePageBody").on("click",".pencilBtn",function(){
			...
			// 为了让执行更新的按钮能够获取到roleId的值，把它放在全局变量上【window.roleId】
		...
		$("#assignBtn").click(function(){
			...
			// [3]获取全部被勾选的节点
			var checkedNodes = zTreeObj.getCheckedNodes(true);/*参数true表示已经勾选，false表示未被勾选*/
			...
			var requestBody = {
				...
				// 为了服务器端handler方法能够统一使用List<Integer>方式接收数据，roleId也存入数组[因为这里面封装为一个Map，统一类型value方便]

package com.company.crowd.filter;
...
import com.company.crowd.constants.AccessPassResources;
...
public class CrowdAccessFilter extends ZuulFilter {
	...
	public boolean shouldFilter() {
		...
		// 2.通过RequestContext对象获取当前请求对象（框架底层是借助ThreadLocal从当前线程上获取事先绑定的Request对象）-->线程本地化
